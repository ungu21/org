...
+(function (a) {
    ...
    function b(b) {
        return this.each(function () {
            ...
            if ("string" == typeof b) {
                if ("undefined" == typeof f[b]) throw new Error("No method named " + b);
                f[b]();
            }
        });
    }
    ...
    (g.prototype.activate = function () {
        ...
        (g.prototype.fix = function () {
            ...
            if (a("body").hasClass(f.fixed)) a(e.contentWrapper).css("min-height", d - b);
                ...
                "undefined" != typeof i && i.height() > h && a(e.contentWrapper).css("min-height", i.height());
            }
        }),
        (g.prototype.fixSidebar = function () {
            return a("body").hasClass(f.fixed)
                ? void (
                      this.options.slimscroll &&
                      "undefined" != typeof a.fn.slimScroll &&
                ...
                : void ("undefined" != typeof a.fn.slimScroll && a(e.sidebar).slimScroll({ destroy: !0 }).height("auto"));
        });
    var h = a.fn.layout;
    (a.fn.layout = b),
    ...
    (function (a) {
        ...
        (h.prototype.init = function () {
            ...
            (h.prototype.open = function () {
                var b = a(window).width();
                b > this.options.collapseScreenSize ? a("body").removeClass(f.collapsed).trigger(a.Event(g.expanded)) : a("body").addClass(f.open).trigger(a.Event(g.expanded));
            }),
    ...
    (function (a) {
        ...
        (h.prototype.toggle = function (a, b) {
            ...
            (h.prototype.expand = function (b, c) {
                ...
                c.addClass(f.open),
                    b.slideDown(this.options.animationSpeed, function () {
            ...
            (h.prototype.collapse = function (b, c) {
                ...
                b.find(e.open).removeClass(f.open),
                    ...
                    b.slideUp(this.options.animationSpeed, function () {
    ...
    (function (a) {
        ...
        (h.prototype.toggle = function () {
            var b = !a(this.element).is(e.collapsed);
            b ? this.collapse() : this.expand();
        }),
            (h.prototype.expand = function () {
            ...
            (h.prototype._setUpListeners = function () {
                ...
                a(this.element).on("click", this.options.collapseTrigger, function (c) {
                    c && c.preventDefault(), b.toggle(a(this));
                }),
                    a(this.element).on("click", this.options.removeTrigger, function (c) {
                        c && c.preventDefault(), b.remove(a(this));
                    });
            });
    ...
    (function (a) {
        ...
        (g.prototype.toggle = function (a) {
            return a.parents(e.li).first().toggleClass(f.done), a.prop("checked") ? void this.check(a) : void this.unCheck(a);
        }),
