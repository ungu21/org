...
class ValidasiUserController  extends Controller
{
    ...
    {
        $data = DB::table('users_validations')
            ->select('users_validations.id' ,'users_validations.user_id', 'users_validations.img_ktp','users_validations.img_selfie','users_validations.img_tabungan','users_validations.status', 'users_validations.created_at','users.name', 'users.email', 'users.phone')
            ->leftjoin('users','users_validations.user_id','users.id')
