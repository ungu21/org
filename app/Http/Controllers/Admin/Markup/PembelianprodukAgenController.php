...
class PembelianprodukAgenController extends Controller
{
    ...
    public function updateHargaSemua(Request $request)
    {
        DB::beginTransaction();
        try{
            $update = Pembelian_markup::where('markup_agen','<>',0)->update([
                'markup_agen' => 0,
                ]);
        ...
        try{
            ...
            foreach($header_trans as $data){
                Pembelian_markup::where('id_product', $data->id)->update([
                     'markup_agen'=> DB::raw('markup_agen '.$aksi.' '.$nominal)
                     ]);
            }
   ...
   //update data by operator
    ...
    public function updateHargaPerKategori(Request $request)
    {
        ...
        try{
            ...
            foreach($getPembelian as $data){
                 Pembelian_markup::where('id_product', $data->id)->where('markup_personal','<>',0)->update([
                    'markup_agen' => 0,
                ]);
            }
    ...
    public function updateHargaPerOperator(Request $request)
    {
        ...
        try{
            ...
            foreach($query as $data){
                ...
                foreach($header_trans as $data_trans){
                   Pembelian_markup::where('id_product', $data_trans->id)->where('markup_agen','<>',0)->update([
                        'markup_agen' => 0,
                        ]);
                }
            }
    ...
    public function edit($jenis,$id)
    {
        ...
        //     ];
            ...
            return view('admin.markup.pembelian.agen.edit', compact('produks','operator'));
        //}
    }
