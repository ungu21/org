...
class LogoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validate = $this->validate($request,[
            'image_icon'=>'mimes:png,jpg,jpeg|image',
            'image_logo_guest'=>'mimes:png,jpg,jpeg|image',
            'image_logo_member_admin'=>'mimes:png,jpg,jpeg|image'
        ],[
            'image_icon.mimes'=>'Format file yang anda masukan tidak valid',
            'image_logo_guest.mimes'=>'Format file yang anda masukkan tidak valid',
            'image_logo_member_admin.mimes'=>'Format file yang anda masukkan tidak valid',
        ]);
