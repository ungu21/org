...
class TransferBankController  extends Controller
{
    ...
    public function statusRefund(Request $requset,$id)
    {
        ...
        try
        {
             ...
             $sumSaldoAdmin    = $sumSaldoNominal + $setting->fee_tf_bank;
            ...
            //insert ke mutasi
             ...
             $mutasi_admin->nominal = $setting->fee_tf_bank;
             $mutasi_admin->saldo   = $sumSaldoAdmin;
             $mutasi_admin->note    = 'Pengembalian Biaya Admin Transfer Saldo ID:#'.$getMutasi->id.' Rp. '.$setting->fee_tf_bank.' dikembalikan';
             $mutasi_admin->save();
