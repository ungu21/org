...
class AppServiceProvider extends ServiceProvider
{
    ...
    {   
        ...
        defined("ENCRYPTION_KEY") or define("ENCRYPTION_KEY", "fn#haPysI5%GhZB&9YwymqI");
        ...
        View::composer(['layouts.member','member.home','member.prabayar','member.pascabayar'], function($view)
        {
        ...
        if( !is_null($pengumuman) ) {
            view()->share('pengumuman', $pengumuman->content);
        }
        else {
