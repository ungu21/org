    ...
    public function handle()
    {
        ...
        //     }
            ...
            if( $duplicateAntrian <= 0 )
            {
                ...
                $transaksisSukses->harga_default = $produk->price_default;
                $transaksisSukses->harga_markup = $produk->price_markup;
                ...
                if($produk->pembelianoperator->product_id == 'PLN'){
                    ...
                    $order = Pulsa::trx_pembelian('PLN',$this->code,$this->target,$transaksisSukses->id,$this->no_meter_pln);
                }else{
                    ...
                    $order = Pulsa::trx_pembelian('I',$this->code,$this->target,$transaksisSukses->id);
                }
    	...
    	catch(Exception $e)
    	{
            ...
            $transaksisGagal->harga_default    = $produk->price_default;
            $transaksisGagal->harga_markup     = $produk->price_markup;
