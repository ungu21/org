...
Jadi 30.000 (jumlah transaksi sebulan) x Rp. {{$komisi->komisi}} = Rp. {{number_format($komisi->komisi * 30000,0,'.','.')}} WOW sungguh luar biasa bukan, ini hanya simulasi kecil dan kami yakin Sobat {{setting()->nama_sistem}} bisa lebih hebat dari itu.
Terima kasih banyak.</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control input-lg" id="ref" type="text" value="{{$coderef}}" readonly style="text-align:center;">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <ol>
                        ...
                        <li>Setiap orang yang diajak dan melakukan transaksi maka Sobat mendapatkan bonus Rp. {{$komisi->komisi}} tiap transaksi.</li>
