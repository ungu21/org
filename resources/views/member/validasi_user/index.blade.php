...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="#" class="btn-loading">Validation Users</a></li>
   </ol>
   </section>
         ...
         <div class="col-md-6">
            <div class="box box-green">
               <div class="box-header">
                 <h3 class="box-title"><a href="{{url('/member')}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>Validasi</h3>
               </div>
               @if(!$validation)
                        ...
                        @if(Session::has('alert-success'))
                         ...
                         <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                               <div class="form-group">
                                    <img id="showKTP" class="img-verification" />
                                </div>
                            </div>
                          </div>
                          <div class="form-group{{ $errors->has('ktp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                               <div class="form-group">
                                    <img id="showgambar" class="img-verification" />
                                </div>
                            </div>
                         <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            <label>Foto Selfie Dengan Memegang Kertas Bertuliskan Nomor HP Akun : </label>
                            ...
                            <div class="col-md-12">
                               <div class="form-group">
                                    <img id="showtabungan" class="img-verification"/>
                                </div>
                            </div>
            ...
            <div class="box box-solid box-penjelasan">
               ...
               <div class="box-body" align="left">
                  ...
                  <p><b>Format :</b>
                    ...
                    <br/>2. MAX SIZE Foto 1,5MB (1536 kb).
                  </p>
               </div><!-- /.box-body -->
            </div><!-- /.box -->
         </div>
