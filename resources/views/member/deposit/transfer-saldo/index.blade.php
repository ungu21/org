                        ...
                        <div class="form-group{{ $errors->has('no_tujuan') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <a id="cek_nomor" class="btn btn-primary btn-flat"><small>Cek Nomor</small></a>
                                </span>
                            </div>
                ...
                <div class="box-body">
                    ...
                    <dd>
                        <ul>
                            ...
                            <li>Anda harus memiliki saldo minimal Rp {{number_format($setting->min_saldo_user,0,'.','.')}} untuk melakukan transfer saldo.</li>
                            <li>Minimal Saldo yang anda transfer adalah Rp. {{number_format($setting->min_nominal_transfer,0,'.','.')}}.</li>
