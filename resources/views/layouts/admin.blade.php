...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <link rel="stylesheet" href="{{asset('css/custom.php?color='.urlencode($GeneralSettings->skin))}}">

    <!-- Bootstrap --> 
    <link rel="stylesheet" type="text/css" href="{{ asset('css/bootstrap.php?color='.urlencode($GeneralSettings->skin)) }}">

    <!-- Admin LTE --> 
    <link rel="stylesheet" type="text/css" href="{{ asset('css/AdminLTE.php?color='.urlencode($GeneralSettings->skin)) }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/_all-skins.php?color='.urlencode($GeneralSettings->skin)) }}">

    <!-- JQUERY UI -->
    <!-- <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/ui-lightness/jquery-ui.css" rel="stylesheet" type="text/css"/> -->

    <!-- ColorPicker --> 
    <!-- <link href="{{ asset('assets/colorpicker/css/colorpicker.css') }}" type="text/css"/> -->
               ...
               <li class="{{ url('/admin/sms-gateway/outbox') == request()->url() ? 'active' : '' }}"><a href="{{url('/admin/sms-gateway/outbox')}}" class="btn-loading"><i class="fa fa-envelope-o" style="text-align: center;"></i> Kotak Keluar</a></li>
                ...
                <li class="treeview">
                   ...
                   <ul class="treeview-menu">
                     ...
                     <li class="{{ url('admin/setting-transfer-saldo') == request()->url() ? 'active' : '' }}"><a href="{{url('admin/setting-transfer-saldo')}}" class="btn-loading"><i class="fa fa-money" style="text-align: center;"></i>Minimal Transfer Saldo</a></li>
                     <li class="{{ url('admin/setting-transfer-saldo') == request()->url() ? 'active' : '' }}"><a href="{{url('admin/setting-transfer-bank')}}" class="btn-loading"><i class="fa fa-money" style="text-align: center;"></i>Transfer Bank</a></li>
