...
<html lang="id">
   ...
   @if(isset($logoku[0]))
    ...
    <link  rel="stylesheet" href="{{asset('/assets/style.css')}}?rev=2">
    <!-- Responsive css -->
         ...
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="{{url('/')}}">
                  @if(isset($logoku[1]))
                    @if($logoku[1]->img !='' || $logoku[1]->img !=null)
                        <span class="logo-lg"><img src="{{asset('img/logo/'.$logoku[1]->img.'')}}" style="width:150px;"></span>
                    @else
            ...
            <div id="navbar" class="navbar-collapse collapse">
               <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                  <li class="{{ url('/') == request()->url() ? 'active' : '' }}"><a href="{{url('/')}}" class="page-scroll nav-link">Home</a></li>
                  <li class="dropdown">
                     <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Panduan</a>
                  ...
                  <li class="dropdown">
                     <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Harga Produk</a>
                  ...
                  <li class="{{ url('/#contactus') == request()->url() ? 'active' : '' }}"><a href="{{url('/#contactus')}}" class="page-scroll nav-link">Kontak Kami</a></li>
                  @if(Auth::check())
                  <li class="member-area"><a href="{{url('/member')}}" class="nav-link"><span class="border">Member Area</span></a></li>
                  @else
                  <li class="member-area"><a href="#!" onclick="loginPopup()" class="nav-link"><span class="border">Login</span></a></li>
                  <li class="member-area"><a href="{{url('/register')}}" class="nav-link"><span class="border">Register</span></a></li>
                  @endif
               </ul>       
            </div><!--/.nav-collapse -->
         </div>   
            ...
            <div class="copyright">
               ...
               <div class="col-sm-5 text-center">
                  <ul class="inline-menu list-unstyled">
                     <li><a class="inline-menu-item" href="{{url('/page/about')}}">Tentang Kami</a></li>
                     <li><a class="inline-menu-item" href="{{url('/page/tos')}}">Terms of Service</a></li>
                     <li><a class="inline-menu-item" href="{{url('/page/privacy-policy')}}">Kebijakan Privasi</a></li>
                  </ul>
               </div>
 ...
 <!-- initialize jQuery Library -->
   ...
   <!-- for twitter plugin -->
   <script src="{{asset('js/twitsFetcher.js')}}"></script>
   <!-- for smooth animatin  -->
