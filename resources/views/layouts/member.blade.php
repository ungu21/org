      ...
      <aside class="main-sidebar">
        ...
        <nav class="box__tab">
            <ul class="nav " role="tablist" id="box__tab">
                ...
                @endphp
                <li class="nav-item" target="_blank" onclick="window.open('{{$link}}')">
