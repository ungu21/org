...
@section('img', asset('assets/images/slider/themate.png'))
@section('css')
           ...
           <div class="no-slider">
               <div class="col-md-12 col-sm-12" style="text-align:center">
                ...
                <div class="animate-block">
                    ...
                    <h1 style="margin-top: 10;margin-bottom:10">Ayo Jualan <span id="word-rotating">Pulsa Elektrik, Paket Internet, Voucher Game, Token PLN, PPOB</span></h1>
                                        ...
                                        @if( $data['type'] == 'PLN' )
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        @if((Auth::check()))
                                                            <button type="submit" name="submit" class="submit btn btn-sm custom__btn-greenHover" id="btn_{{strtolower(str_replace(' ', '', $data['product_name']))}}">BELI SEKARANG</button>
                                                        @else
                                                            <a href="{{url('/login')}}" class="submit btn btn-sm custom__btn-greenHover">BELI SEKARANG</a>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <section id="section-flip-10000" class="">
                                  <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <button {!! Auth::check() ? 'id="cek_tagihan"' : 'onclick="javascript:window.open(\''.route('login').'\', \'_self\');"' !!} class="submit btn btn-sm custom__btn-greenHover">CEK TAGIHAN</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        TAGIHAN PASCABAYAR
      ...
      <div class="row">
         <div class="col-md-10 col-md-offset-1">
            <div class="section-heading text-center">
               <h2 class="title">Mengapa memilih {{$GeneralSettings->nama_sistem}}?</h2>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div align="center" style="margin-top:20px;">
            <a href="{{url('/testimonial')}}" class="btn custom__btn-greenHover btn-lg" style="width:200px;">Lihat Semua</a>
         </div>
      </div>
   </div>
</section>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div align="center" style="margin-top:50px;">
            <a href="{{url('/faq')}}" class="btn custom__btn-greenHover btn-lg" style="width:200px;">Lihat Semua</a>
         </div>
      </div>
   </div>
</section>
               ...
               <form id="contact-form" role="form" novalidate="true">
                  ...
                  <div class="controls">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <input class="btn custom__btn-greenHover btn-send" onclick="sendMessage()" value="Kirim Pesan" name="submit" type="button">
                        </div>
                     </div>
                  </div>
               </form>
            ...
            <div class="contact-info padding-2x">
               <div class="medium">
                  <div class="medium-left">
                     <i class="icon-map fa-3x" aria-hidden="true" style="color: #32CD32;"></i>
                  </div>
               ...
               <div class="medium">
                  <div class="medium-left">
                     <i class="icon-envelope fa-3x" aria-hidden="true" style="color: #32CD32;"></i>
                  </div>
                  <div class="medium-body">
               ...
               <div class="medium">
                  <div class="medium-left">
                     <i class="icon-lifesaver fa-3x" aria-hidden="true" style="color: #32CD32;"></i>
                  </div>
                  <div class="medium-body">
                ...
                success: function (response) {
                    ...
                    $.each(response, function(index, produkObj){
                            ...
                            if (produkObj.status == 0) {
                                ...
                                $('#product_'+$product).append('<option value="'+produkObj.product_id+'">'+produkObj.product_name+' ('+rupiah(harga)+')</option>');
                            }
                        });
                },
                error: function (response) {
