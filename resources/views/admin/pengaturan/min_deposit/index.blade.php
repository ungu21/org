   ...
   <section class="content">
      <div class="row">
          <div class="alert alert-warning" role="alert">
              Untuk minimal nominal deposit dan fee deposit harap isi dengan satuan rupiah contoh: 1000,2000
          </div>
         <div class="col-md-6">
            <div class="box box-green">
               ...
               {{csrf_field()}}
                  <div class="box-body">
                    ...
                    <small><i>Note: Buat nominal menjadi 0 apabila tidak ingin menetapkan minimal deposit</i></small>
                  </div>
            ...
            <div class="box box-green">
               ...
               {{csrf_field()}}
                  <div class="box-body">
                     ...
                     <small><i>Note: Buat fee menjadi 0 apabila tidak ingin menetapkan fee deposit</i></small>
                  </div>
                  <div class="box-footer">
                     <button type="submit" class="submit btn btn-primary">Simpan</button>
                  </div>
