  ...
  <div class="row">
      <div class="col-md-12">
          <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD;text-align:center;">
              <div class="pull-left" style="padding-left:10px;padding-right:10px;padding-bottom:5px;padding-top:10px;margin-top:0px;font-style:italic;">Status Server ({{$GeneralSettings->nama_sistem}})</div>
   ...
   <div class="row">
      ...
      <div class="col-md-3">
         <div class="box box-green">
            ...
            <div class="box-body">
                  <center>
                    <p style="font-style: italic;margin-top:10px;">Saldo Tripay <br><label><u>Rp {{number_format($saldo, 0, '.', '.')}}</u></label></p>
